									...
									<table class="table table-striped">
										...
										<tbody>
                                            ...
                                            <tr>
                                                <td>{{$s++}}</td>
                                                <td>{{$mapel->nama}}</td>
                                                <td><a href="#" class="nilai" data-type="text" data-pk="{{$mapel->id}}" data-url="/api/data-nilai/{{$siswa->id}}/editnilai" data-title="Masukkan Nilai">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
					<form action="/data-nilai/{{$siswa->id}}/addnilai" method="POST">
						{{ csrf_field() }}
						...
						<div class="form-group">
							<label>Nilai</label>
							<input class="form-control" type="text" name="nilai" placeholder="Masukkan Nilai">
						</div>
                </div>
